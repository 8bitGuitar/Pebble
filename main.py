...
async def chat(ctx, *, message):
    try:
        async with ctx.typing():
            ...
            systemContext = (
                f"Context from uploaded files:\n{fileContexts[userId]}\n,If user asks something which is not related to the contex from the uploaded file, answer normally." if fileContexts[userId] else "") + ("You are a helpful assistant. Please keep your responses concise and format them "
